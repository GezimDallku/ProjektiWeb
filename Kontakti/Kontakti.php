...
<body>
    ...
    <div class="container">
        <form name="Konktakti" id="Konktakti" action="../includes/kontaktform.php" method="post" onsubmit="return validateForm()">
            ...
            <!--<button type="submit" value="Dergo"-->
        ...
        <div class="fundi">
            ...
            <div>
                ...
                <div id="lincet">
                    <br>
                    <h3>Lincet :</h3>
                    <li><a href="file:///C:/Users/Admin/Desktop/CSE/Web/Projekti/Veturat/Veturat.html">Veturat ne shtije</a></li>
                    <li><a href="C:\Users\Admin\Desktop\CSE\Web\Projekti\LogIn\LogIn.html">LogIn</a></li>
                    <li><a href="C:\Users\Admin\Desktop\CSE\Web\Projekti\Kontakti\Kontakti.html">Kontakti</a></li>
